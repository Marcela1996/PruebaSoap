...
a persistence unit "CarritoComprasPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "CarritoCompras\pom.xml":
...
artifact ("CarritoCompras.war") is already built. You can build
